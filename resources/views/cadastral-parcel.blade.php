    ...
    <table class="interventions-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td></td>
                <td></td>
                <td>{{ $cadastralParcel->catalog_estimate['interventions']['info']['business_profit_price'] }}€</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>{{ $sisteco['platform_maintenance']['value'] . $sisteco['platform_maintenance']['unit'] }} </td>
                <td></td>
                <td></td>
            ...
            <tr>
                ...
                <td></td>
                <td></td>
                <td>{{ $cadastralParcel->catalog_estimate['interventions']['info']['total_intervention_vat'] }}</td>
            </tr>
            <tr>
